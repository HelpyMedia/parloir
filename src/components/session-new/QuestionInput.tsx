...
export function QuestionInput({ title, question, onTitle, onQuestion }: Props) {
  return (
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <input
          ...
          maxLength={200}
          className="w-full rounded-lg border border-[var(--color-border-subtle)] bg-[var(--color-surface-card)] px-4 py-2.5 font-display text-lg text-[var(--color-text-primary)] placeholder:text-[var(--color-text-dim)] focus:border-[var(--color-spot-warm)] focus:outline-none"
        />
      </div>
      <div className="space-y-1.5">
        <label
        ...
        />
        <div className="flex justify-between font-mono text-[10px] uppercase tracking-wide text-[var(--color-text-dim)]">
